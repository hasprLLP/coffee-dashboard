  ...
  return (
    <div className="home">
      <div className="home-shift">
        ...
        <div className="layout-row" style={{ alignItems: 'flex-start' }}>
          <div className="layout-row-item">
            <div className="layout-form" style={{ justifyContent: 'flex-start', alignItems: 'flex-end' }}>
              {/* //$ Student Info */}
              <div style={{ width: '100%' }}>
                <div style={{ width: '12vw', height: '12vw', marginTop: '1vw', resizeMode: 'cover' }}>
                  <img
        ...
        {/* //$ View Documents */}
        <div className="layout-sub-title">Uploaded Documents</div>
        <div className="layout-form" style={{ justifyContent: 'flex-start' }}>
          {[...new Array(6)].map((item, index) => {
            return (
              <div key={index} style={{ width: '35vw', height: 'auto', marginTop: '1vw', marginRight: '1vw' }}>
                <img
                  alt="No Photo Available"
                  // src={data?.photo}
